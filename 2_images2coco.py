...
def parse_args():
    ...
    parser.add_argument('--img_path', help='The root path of images',default='data/test_images')
    parser.add_argument(
        '--classes', type=str, help='The text file name of storage class list',default='data/classes.txt')
    parser.add_argument(
        '--out',
        type=str,
        default='data/test_submit.json',
